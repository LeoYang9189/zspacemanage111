    ...
    <div>
        ...
        <div class="marquee-tip">
            <div class="marquee-content">
                ...
                <span class="marquee-text">在网站完成注册的用户信息，将会显示在这里，用于后续跟进</span>
            </div>
        </div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <el-table size="large" v-loading="pager.loading" :data="pager.lists">
                ...
                <el-table-column label="企业名称" prop="username" min-width="120" />
                <el-table-column label="手机号码" prop="phone" min-width="100" />
                <el-table-column label="邮箱" prop="email" min-width="120" />
                <el-table-column label="客户类型" prop="userRole" min-width="120" />
                ...
                <el-table-column label="最近登录时间" prop="lastLoginTime" min-width="120" />
